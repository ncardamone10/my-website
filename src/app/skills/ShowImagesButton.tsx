    ...
    return (
        <>
            ...
            <button
                ...
                className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-lg shadow-lg transition transform hover:scale-105 mt-4"
            >
                Show Me Pictures
            </button>
                        ...
                        {images.length > 0 && (
                            <div className="relative flex items-center justify-center w-full">
                                ...
                                <img
                                    ...
                                    alt={`Skill Image ${currentImageIndex + 1}`}
